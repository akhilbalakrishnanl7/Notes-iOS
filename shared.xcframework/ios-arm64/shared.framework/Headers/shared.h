...
- (instancetype)initWithNoteDatabase:(id<SharedNoteDatabase>)noteDatabase __attribute__((swift_name("init(noteDatabase:)"))) __attribute__((objc_designated_initializer));
...
@property (class, readonly) int64_t AntiFlashWhite __attribute__((swift_name("AntiFlashWhite")));
@property (class, readonly) int64_t BabyBlueHex __attribute__((swift_name("BabyBlueHex")));
@property (class, readonly) int64_t BattleshipGray __attribute__((swift_name("BattleshipGray")));
@property (class, readonly) int64_t BitterSweet __attribute__((swift_name("BitterSweet")));
@property (class, readonly) int64_t Cerise __attribute__((swift_name("Cerise")));
@property (class, readonly) int64_t Charcoal __attribute__((swift_name("Charcoal")));
@property (class, readonly) int64_t Copper __attribute__((swift_name("Copper")));
@property (class, readonly) int64_t CosmicLatte __attribute__((swift_name("CosmicLatte")));
@property (class, readonly) int64_t DarkGreen __attribute__((swift_name("DarkGreen")));
@property (class, readonly) int64_t DavysGray __attribute__((swift_name("DavysGray")));
@property (class, readonly) int64_t DelftBlue __attribute__((swift_name("DelftBlue")));
@property (class, readonly) int64_t Dun __attribute__((swift_name("Dun")));
@property (class, readonly) int64_t EerieBlack __attribute__((swift_name("EerieBlack")));
@property (class, readonly) int64_t Feldgrau __attribute__((swift_name("Feldgrau")));
@property (class, readonly) int64_t Flax __attribute__((swift_name("Flax")));
@property (class, readonly) int64_t FrenchViolet __attribute__((swift_name("FrenchViolet")));
@property (class, readonly) int64_t GiantsOrange __attribute__((swift_name("GiantsOrange")));
@property (class, readonly) int64_t Gunmetal __attribute__((swift_name("Gunmetal")));
@property (class, readonly) int64_t Jade __attribute__((swift_name("Jade")));
@property (class, readonly) int64_t LapisLazuli __attribute__((swift_name("LapisLazuli")));
@property (class, readonly) int64_t LavenderPink __attribute__((swift_name("LavenderPink")));
@property (class, readonly) int64_t LightGreen __attribute__((swift_name("LightGreen")));
@property (class, readonly) int64_t LightGreenHex __attribute__((swift_name("LightGreenHex")));
@property (class, readonly) int64_t Lion __attribute__((swift_name("Lion")));
@property (class, readonly) int64_t MistyRose __attribute__((swift_name("MistyRose")));
@property (class, readonly) int64_t Nyanza __attribute__((swift_name("Nyanza")));
@property (class, readonly) int64_t Peach __attribute__((swift_name("Peach")));
@property (class, readonly) int64_t PennRed __attribute__((swift_name("PennRed")));
@property (class, readonly) int64_t Plum __attribute__((swift_name("Plum")));
@property (class, readonly) int64_t Purple __attribute__((swift_name("Purple")));
...
@property (class, readonly) int64_t Redwood __attribute__((swift_name("Redwood")));
@property (class, readonly) int64_t RoseQuartz __attribute__((swift_name("RoseQuartz")));
@property (class, readonly) int64_t SelectiveYellow __attribute__((swift_name("SelectiveYellow")));
@property (class, readonly) int64_t Silver __attribute__((swift_name("Silver")));
@property (class, readonly) int64_t SpaceCadet __attribute__((swift_name("SpaceCadet")));
@property (class, readonly) int64_t TeaGreen __attribute__((swift_name("TeaGreen")));
@property (class, readonly) int64_t TiffanyBlue __attribute__((swift_name("TiffanyBlue")));
@property (class, readonly) int64_t TimberWolf __attribute__((swift_name("TimberWolf")));
@property (class, readonly) int64_t VioletHex __attribute__((swift_name("VioletHex")));
@property (class, readonly) int64_t WhiteSmoke __attribute__((swift_name("WhiteSmoke")));
@property (class, readonly) int64_t Wisteria __attribute__((swift_name("Wisteria")));
@end
